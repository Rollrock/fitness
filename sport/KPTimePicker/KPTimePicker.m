...
#define kClockLabelFont [UIFont fontWithName:@"HelveticaNeue-Light" size:valForScreen(65,85)]
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backButton.frame = CGRectMake(kBackMargin, kBackButtonSize-kBackMargin*3, kBackButtonSize, kBackButtonSize);
